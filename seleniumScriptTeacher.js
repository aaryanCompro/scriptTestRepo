...
async function login() {
  try {
    ...
    let username = isNewRelicEnvironment() ? $secure.TEACHER_USERNAME_QA : loginUsername;
    let password = isNewRelicEnvironment() ? $secure.TEACHER_PASSWORD_QA : loginPassword;
